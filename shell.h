...
/* Referring to an array of pointers to strings, commonly known as the "environment" */
extern char **environ;


/**
 * struct ctxt - A structure that encompasses all essential ctxtary data during runtime.
 * @argv: argument vector
 * @cmd: command line written by the user
 * @args: tokens of the command line
 * @exit_code: last exit_code of the shell
 * @count: lines count
 ...
 * @separator: ; | &
 * @next: next node
 * Description: A singly linked list designed to store separators.
 */
typedef struct sep
{
	char separator;
...
/**
 * struct bin - context struct for command args.
 * @name: The name of the command context i.e cd, exit, env
 * @f: ctxt type pointer function.
 */
typedef struct bin
{
	char *name;
